...
import { NewsEventComponent } from './components/pages/news-event/news-event.component';
import { TrainingCalendarRegistrationComponent } from './components/pages/training-calendar-registration/training-calendar-registration.component';
...
const routes: Routes = [
    ...
    {
        path: 'trannings',
        loadChildren: () => import('./components/pages/trainings/trainings.module').then(m => m.TrainingsModule)
    },
    {
        path: 'resources',
        loadChildren: () => import('./components/pages/resources/resources.module').then(m => m.ResourcesModule)
    },
    {
        path: 'company',
